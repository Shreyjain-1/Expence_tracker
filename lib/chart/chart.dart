...
class Chart extends StatelessWidget {
  ...
  List<ExpenceBucket> get buckets {
    return [
      ExpenceBucket.forType(ExpenceType.food,expenses),
      ExpenceBucket.forType(ExpenceType.leisure, expenses),
      ExpenceBucket.forType(ExpenceType.travel, expenses),
      ExpenceBucket.forType(ExpenceType.work, expenses),
    ];
  }
